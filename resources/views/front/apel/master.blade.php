      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="/about/center">APEL Center</a></li>
            <li><a href="/about/service">Our Services</a></li>
          </ul>
        </li>
       {{--  <li class="dropdown">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="/credits/intro">Introduction</a></li>
				<li><a href="/credits/rules">Rules & Regulation</a></li>
				<li><a href="/credits/eligibility">Eligibility</a> </li>
				<li><a href="/credits/awards">Awards of Credit</a></li>
